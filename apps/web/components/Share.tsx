...
export default function Share({ OnClose }: { OnClose: () => void }) {
        ...
        {isCollaborative ? (
          <>
            ...
            <p className="text-sm text-gray-300 mb-6">
              Share this link to allow others to{" "}
              <span className="text-white font-medium">view</span> the document.
            </p>
          ...
          <div className="text-center space-y-4 py-8">
            ...
            <p className="text-sm text-gray-400 px-2">
              This document isn&apos;t in collaborative mode yet. Enable
              collaboration to generate a view-only link.
            </p>
            <button
              onClick={OnClose}
              className="bg-blue-600 hover:bg-blue-500 px-4 py-2 rounded-lg text-sm font-medium cursor-pointer"
